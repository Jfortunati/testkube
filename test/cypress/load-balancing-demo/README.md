# Load Balancing Demo Test Suite

This Cypress test suite is designed to demonstrate the need for "Smart Load Balancing" in Testkube.
...
This suite contains 50 test files (`LB-test-01.spec.js` through `LB-test-50.spec.js`).
...
This is a standard Cypress project. Install dependencies and run tests as usual:
